var template = 'android';

var constants = {

    // live server
    home: '#newsfeed',
    siteUrl: 'http://doemyanmar.com/',
    apiUrl: 'http://doemyanmar.com/module/mfox/api.php/',
    cometApiUrl: 'http://doemyanmar.com/cometchat/cometchat_api.php?q=',
    ...
    token: '',
    theme: 'android',
    template: 'android', // set template to load.
    platform: 'android',
    device: 'android',
    applePushPlatformName: 'ipad', // ios, ipad
    googleCloudMessageSenderId: '340618586113',
