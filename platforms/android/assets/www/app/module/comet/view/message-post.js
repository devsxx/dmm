define([
    'text!comet/tpl/message-post.html',
    'comet/model/message',
    'core'
], function() { 
    var text = require('text!comet/tpl/message-post.html')
      , Message = require('comet/model/message')
      , core = require('core')
    ...
    var PostView = Backbone.View.extend({
        ...
        sendMessage: function() {
            ...
            utils.api.cometPost('chat/sendmessage', data, settings).done(this.postDone).always(this.postComplete).fail(this.postFail);
        },
